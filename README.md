...
![GitHub Actions](https://img.shields.io/github/actions/workflow/status/Tupig/GitHubDesktop2Chinese/build.yml)
![GitHub Actions](https://img.shields.io/github/actions/workflow/status/Tupig/GitHubDesktop2Chinese/check.yml?label=json检查)
![GitHub Release](https://img.shields.io/github/v/release/Tupig/GitHubDesktop2Chinese)
![GitHub Release](https://img.shields.io/badge/Cpp-json-blue?logo=cplusplus)
![GitHub License](https://img.shields.io/github/license/Tupig/GitHubDesktop2Chinese)
...
> 如果报错提示找不到openssl 的dll文件，请更新到[最新版](https://github.com/Tupig/GitHubDesktop2Chinese/releases)   
  如果你有任何建议可以提issues.
...
## 🍬星标(收藏)历史
![Star History Chart](https://star-history.dera.page/svg?repos=Tupig/GitHubDesktop2Chinese&type=Date)
